...
# # to be final trans model , related_name='transactions'
# class CreditCard_Transaction(models.Model):
#     card = models.ForeignKey('CreditCard', on_delete=models.CASCADE)
#     transaction_date = models.DateField()
#     posted_date = models.DateField()
#     description = models.CharField(max_length=255)
#     category = models.CharField(max_length=255)
#     # Debit indicates payment was made, so it's a negative value
#     debit = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
#     # Credit indicates money was added, so it's a positive value
#     credit = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
#     date = models.DateField(auto_now_add=True)
...
# # Retrieve the object
# product = Product.objects.get(id=1)  # Assuming you want to update the product with id=1
